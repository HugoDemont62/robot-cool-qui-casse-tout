...
aruco_marker_side_length = 0.066
...
def main():
    if ARUCO_DICT.get(aruco_dictionary_name, None) is None:
        print("[INFO] ArUCo tag '{}' is not supported".format(aruco_dictionary_name))
        return
    ...
    while (True):
        ret, frame = cap.read()
        (corners, marker_ids, rejected) = cv2.aruco.detectMarkers(frame, this_aruco_dictionary,
